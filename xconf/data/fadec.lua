{
	["fadec"] = 
	{
		...
		["dev_info"] =
		{
		  ["hwver"] ="v0.0, эмулятр устройства fadec",
		  ["fwver"] ="v0.0, отладочный код для эмулятора утсройсва fadec",
		  ["sernum"] ="347837913438"
		},
		["control"] = {
			["name"] = "управление",
			...
			["channel4_tim4"] = {
				...
				["pwm_freq"] = {
					["name"] = " частота ШИМ",
					["info"] = "Параметр определяет частоту включения и отключения клапана основной подачи топлива в камеру сгорания",
					["typeof"] = "uint32_t",
					["unit"] = "[Гц]",
					["val"] = 100,
					["val_min"] = 0,
			...
			["channel5_tim2"] = {
				...
				["pwm_freq"] = {
					["name"] = " частота ШИМ",
					["info"] = "Параметр определяет частоту включения и отключения свечи накаливания",
					["typeof"] = "uint32_t",
					["unit"] = "[Гц]",
					["val"] = 100,
					["val_min"] = 0,
