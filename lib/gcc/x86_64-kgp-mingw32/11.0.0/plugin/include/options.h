...
#define OPTION_MASK_ISA2_SERIALIZE (HOST_WIDE_INT_1U << 15)
#define OPTION_MASK_ISA2_SGX (HOST_WIDE_INT_1U << 16)
...
#define OPTION_MASK_ISA2_TSXLDTRK (HOST_WIDE_INT_1U << 17)
#define OPTION_MASK_ISA2_VAES (HOST_WIDE_INT_1U << 18)
#define MASK_VECT8_RETURNS (1U << 28)
#define OPTION_MASK_ISA_VPCLMULQDQ (HOST_WIDE_INT_1U << 57)
#define MASK_VZEROUPPER (1U << 29)
#define OPTION_MASK_ISA2_WAITPKG (HOST_WIDE_INT_1U << 19)
#define OPTION_MASK_ISA2_WBNOINVD (HOST_WIDE_INT_1U << 20)
...
#endif
#if defined(HOST_BITS_PER_WIDE_INT) && 21 > HOST_BITS_PER_WIDE_INT
...
enum opt_code
{
  ...
  OPT_flarge_source_files = 1153,            /* -flarge-source-files */
  ...
  OPT_fset_stack_executable = 1364,          /* -fset-stack-executable */
  ...
  OPT_fwritable_relocated_rdata = 1539,      /* -fwritable-relocated-rdata */
  ...
  OPT_list = 1598,                           /* -list */
  OPT_m128bit_long_double = 1599,            /* -m128bit-long-double */
  OPT_m16 = 1600,                            /* -m16 */
  OPT_m32 = 1601,                            /* -m32 */
  OPT_m3dnow = 1602,                         /* -m3dnow */
  OPT_m3dnowa = 1603,                        /* -m3dnowa */
  OPT_m64 = 1604,                            /* -m64 */
  OPT_m80387 = 1605,                         /* -m80387 */
  OPT_m8bit_idiv = 1606,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1607,             /* -m96bit-long-double */
  OPT_mabi_ = 1608,                          /* -mabi= */
  OPT_mabm = 1609,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1610,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1611,                 /* -maddress-mode= */
  OPT_madx = 1612,                           /* -madx */
  OPT_maes = 1613,                           /* -maes */
  OPT_malign_data_ = 1614,                   /* -malign-data= */
  OPT_malign_double = 1615,                  /* -malign-double */
  OPT_malign_functions_ = 1616,              /* -malign-functions= */
  OPT_malign_jumps_ = 1617,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1618,                  /* -malign-loops= */
  OPT_malign_stringops = 1619,               /* -malign-stringops */
  OPT_march_ = 1620,                         /* -march= */
  OPT_masm_ = 1621,                          /* -masm= */
  OPT_mavx = 1622,                           /* -mavx */
  OPT_mavx2 = 1623,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1624,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1625,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1626,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1627,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1628,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1629,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1630,                      /* -mavx512bw */
  OPT_mavx512cd = 1631,                      /* -mavx512cd */
  OPT_mavx512dq = 1632,                      /* -mavx512dq */
  OPT_mavx512er = 1633,                      /* -mavx512er */
  OPT_mavx512f = 1634,                       /* -mavx512f */
  OPT_mavx512ifma = 1635,                    /* -mavx512ifma */
  OPT_mavx512pf = 1636,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1637,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1638,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1639,                      /* -mavx512vl */
  OPT_mavx512vnni = 1640,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1641,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1642,               /* -mavx512vpopcntdq */
  OPT_mbmi = 1643,                           /* -mbmi */
  ...
  OPT_mconsole = 1654,                       /* -mconsole */
  /* OPT_mcpu_ = 1655, */                    /* -mcpu= */
  OPT_mcrc32 = 1656,                         /* -mcrc32 */
  OPT_mcx16 = 1657,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1658,            /* -mdispatch-scheduler */
  OPT_mdll = 1659,                           /* -mdll */
  OPT_mdump_tune_features = 1660,            /* -mdump-tune-features */
  OPT_menqcmd = 1661,                        /* -menqcmd */
  OPT_mf16c = 1662,                          /* -mf16c */
  OPT_mfancy_math_387 = 1663,                /* -mfancy-math-387 */
  OPT_mfentry = 1664,                        /* -mfentry */
  OPT_mfentry_name_ = 1665,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1666,               /* -mfentry-section= */
  OPT_mfma = 1667,                           /* -mfma */
  OPT_mfma4 = 1668,                          /* -mfma4 */
  OPT_mforce_drap = 1669,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1670,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1671,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1672,                       /* -mfpmath= */
  OPT_mfsgsbase = 1673,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1674,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1675, */              /* -mfused-madd */
  OPT_mfxsr = 1676,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1677,             /* -mgeneral-regs-only */
  OPT_mgfni = 1678,                          /* -mgfni */
  OPT_mhard_float = 1679,                    /* -mhard-float */
  OPT_mhle = 1680,                           /* -mhle */
  OPT_miamcu = 1681,                         /* -miamcu */
  OPT_mieee_fp = 1682,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1683,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1684,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1685,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1686,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1687,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1688,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1689, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1690,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1691,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1692,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1693,                /* -mlong-double-80 */
  OPT_mlwp = 1694,                           /* -mlwp */
  OPT_mlzcnt = 1695,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1696,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1697,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1698,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1699,                  /* -mmitigate-rop */
  OPT_mmmx = 1700,                           /* -mmmx */
  OPT_mmovbe = 1701,                         /* -mmovbe */
  OPT_mmovdir64b = 1702,                     /* -mmovdir64b */
  OPT_mmovdiri = 1703,                       /* -mmovdiri */
  OPT_mmpx = 1704,                           /* -mmpx */
  OPT_mms_bitfields = 1705,                  /* -mms-bitfields */
  ...
  OPT_mnop_fun_dllimport = 1713,             /* -mnop-fun-dllimport */
  OPT_mnop_mcount = 1714,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1715,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1716,                          /* -mpc32 */
  OPT_mpc64 = 1717,                          /* -mpc64 */
  OPT_mpc80 = 1718,                          /* -mpc80 */
  OPT_mpclmul = 1719,                        /* -mpclmul */
  OPT_mpcommit = 1720,                       /* -mpcommit */
  OPT_mpconfig = 1721,                       /* -mpconfig */
  OPT_mpe_aligned_commons = 1722,            /* -mpe-aligned-commons */
  OPT_mpku = 1723,                           /* -mpku */
  OPT_mpopcnt = 1724,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1725, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1726,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1727,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1728,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1729,                        /* -mprfchw */
  OPT_mptwrite = 1730,                       /* -mptwrite */
  OPT_mpush_args = 1731,                     /* -mpush-args */
  OPT_mrdpid = 1732,                         /* -mrdpid */
  OPT_mrdrnd = 1733,                         /* -mrdrnd */
  OPT_mrdseed = 1734,                        /* -mrdseed */
  OPT_mrecip = 1735,                         /* -mrecip */
  OPT_mrecip_ = 1736,                        /* -mrecip= */
  OPT_mrecord_mcount = 1737,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1738,                 /* -mrecord-return */
  OPT_mred_zone = 1739,                      /* -mred-zone */
  OPT_mregparm_ = 1740,                      /* -mregparm= */
  OPT_mrtd = 1741,                           /* -mrtd */
  OPT_mrtm = 1742,                           /* -mrtm */
  OPT_msahf = 1743,                          /* -msahf */
  OPT_mserialize = 1744,                     /* -mserialize */
  OPT_msgx = 1745,                           /* -msgx */
  OPT_msha = 1746,                           /* -msha */
  ...
  OPT_mstv = 1768,                           /* -mstv */
  OPT_mtbm = 1769,                           /* -mtbm */
  OPT_mthreads = 1770,                       /* -mthreads */
  OPT_mtls_dialect_ = 1771,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1772,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 1773,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 1774,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1775,                         /* -mtune= */
  OPT_muse_libstdc_wrappers = 1776,          /* -muse-libstdc-wrappers */
  OPT_mvaes = 1777,                          /* -mvaes */
  OPT_mveclibabi_ = 1778,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1779,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1780,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1781,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1782,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1783,                      /* -mwbnoinvd */
  OPT_mwin32 = 1784,                         /* -mwin32 */
  OPT_mwindows = 1785,                       /* -mwindows */
  OPT_mx32 = 1786,                           /* -mx32 */
  OPT_mxop = 1787,                           /* -mxop */
  OPT_mxsave = 1788,                         /* -mxsave */
  OPT_mxsavec = 1789,                        /* -mxsavec */
  OPT_mxsaveopt = 1790,                      /* -mxsaveopt */
  OPT_mxsaves = 1791,                        /* -mxsaves */
  OPT_n = 1792,                              /* -n */
  ...
  OPT_no_pthread = 1797,                     /* -no-pthread */
  ...
  OPT_static_liblsan = 1847,                 /* -static-liblsan */
  OPT_static_libmpx = 1848,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1849,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1850,               /* -static-libphobos */
  OPT_static_libstdc__ = 1851,               /* -static-libstdc++ */
  OPT_static_libtsan = 1852,                 /* -static-libtsan */
  OPT_static_libubsan = 1853,                /* -static-libubsan */
  OPT_static_pie = 1854,                     /* -static-pie */
  /* OPT_std_c__03 = 1855, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1856, */                /* -std=c++0x */
  OPT_std_c__11 = 1857,                      /* -std=c++11 */
  OPT_std_c__14 = 1858,                      /* -std=c++14 */
  OPT_std_c__17 = 1859,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1860, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1861, */                /* -std=c++1z */
  /* OPT_std_c__20 = 1862, */                /* -std=c++20 */
  OPT_std_c__2a = 1863,                      /* -std=c++2a */
  ...
  OPT_std_gnu__2a = 1888,                    /* -std=gnu++2a */
